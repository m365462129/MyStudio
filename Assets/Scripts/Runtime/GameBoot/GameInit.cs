...
public class GameInit : LuaClient
{
    ...
    protected void Awake() {
        try {
            BuglyAgent.ConfigDefault("DHQPYX", Application.version, PlayerPrefs.GetString("PlayerPrefs_Login_USERID", "0"), 0);
...
//                PlayerPrefs.DeleteAll();
				...
				{
				    FileUtility.DirectoryDelete(Application.persistentDataPath + "/assetsdata", true);
				}
