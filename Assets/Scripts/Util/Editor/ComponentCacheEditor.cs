...
public class ComponentCacheEditor : Editor 
{
	...
	private int GetBindedComponentsCount()
	{
		...
		if(m_cache.quickGridList != null){
			totalCount += m_cache.quickGridList.Count; 
		}
		if(m_cache.simpleScrollViewList != null){
			totalCount += m_cache.simpleScrollViewList.Count; 
		}
	...
	public override void OnInspectorGUI ()
	{
		...
		// 	EditorGUILayout.HelpBox("No components cached yet!", MessageType.Info);
			...
			this.ShowComponentList<ComponentCache.QuickGrid_Injection,littlerbird.UI.QuickGrid>("QuickGrid", m_cache.quickGridList);
			this.ShowComponentList<ComponentCache.SimpleScrollView_Injection,SimpleScrollView>("SimpleScrollView", m_cache.simpleScrollViewList);
