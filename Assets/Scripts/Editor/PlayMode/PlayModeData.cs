...
namespace PlayModeEditor{
	...
	public class PlayModeInfo{
		...
		public string openUrl = "http://www.sincebest.com/";
		...
		public string GetString()
		{
			...
			sb.Append(space + "color        = "   + (int)color+ ",\n");
			sb.Append(space + "isOnline     = "   + isOnline.ToString().ToLower() + ",\n");
			sb.Append(space + "isOpenGold   = "   + isOpenGold.ToString().ToLower() + ",\n");
			sb.Append(space + "coinName     = \"" + coinName.Trim()  + "\",\n");
			sb.Append(space + "isOpenUrl    = " + isOpenUrl.ToString().ToLower() + ",\n");
			if(playTypeName != "")
				sb.Append(space + "playTypeName = \"" + playTypeName.Trim()  + "\",\n");
			if(isOpenUrl)
				sb.Append(space + "openUrl      = \"" + openUrl.Trim()   +  "\",\n");
			if(wanfaType != "")
	...
	public class ProvinceData{
		...
		public string modName = "";               // 该省份的玩法Mod在哪 如:package.henanmj.module.playmodeconfigs.anhui_config
		...
		public string GetString()
		{
			...
			sb.Append(space + "modName      = "   + "\"package.henanmj.module.playmodeconfigs." + gameName.ToLower().Trim()   + "_config\",\n");
			if(isOpenUrl)
				sb.Append(space + "openUrl      = \"" + openUrl.Trim()   +  "\",\n");
			if(tips != "")
				sb.Append(space + "tips         = \"" + tips.Trim()  + "\",\n");
	...
	public class PlayModeTools{
		...
		public static string provinceLuaPath
		{
			get
			{
				return Application.dataPath + "/LuaFramework/Lua/package/henanmj/module/playmodeconfigs/all_configs.lua";
			}
		}
		...
		public static string luaPath
		{
			get
			{
				return Application.dataPath + "/LuaFramework/Lua/package/henanmj/module/playmodeconfigs/" + data.configs[curProvince].gameName.ToLower() + "_config.lua";
			}
		}
		...
		public static void ExportLuaScript()
		{
			...
			for(int i = 0; i < data.configs.Count; i++)
			{
				string path = Application.dataPath + "/LuaFramework/Lua/package/henanmj/module/playmodeconfigs/" + data.configs[i].gameName.ToLower() + "_config.lua";
