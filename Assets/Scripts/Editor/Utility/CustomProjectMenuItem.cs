...
public class CustomProjectMenuItem
{
    ...
    [MenuItem("Tools/Proto生成", false, 3)]
    ...
    private static string GenGenCmds(out string outDirPath)
    {
        ...
        string[] filePaths = System.IO.Directory.GetFiles(protoDirPath, "*.proto", SearchOption.AllDirectories);
