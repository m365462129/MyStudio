...
public class AseetBundleUpload {
	...
	static string accessKeyId = "LTAIPNuEYMC30imR";
	static string accessKeySecret = "jxkDnZDCUYZ4G0Fz7J1VDp6bOqOuk7";
	static string host = "sincebest-game-client.oss-cn-hangzhou.aliyuncs.com";
