...
public class EditorGameBuildTool : EditorWindow
{
    ...
    private string mAssetVersionUploadServerLog = "更新详情见tapd";
    ...
    //公司的产品研发群
    private string url_dingding = "https://oapi.dingtalk.com/robot/send?access_token=80790585bc258cb8dbfef7027599fd20be11b810fa9d6130abfac66e8d5f321d";
    //龙涛个人测试
    // private string url_dingding = "https://oapi.dingtalk.com/robot/send?access_token=88cfdfe4c8d9a18cec05947e6c1dea5ece066f52735a1bc81beb6ca90e561a4a";
    ...
    private string url_Credentials = "http://api.fir.im/apps";//获取凭证url
    private string url_upload = "http://upload.qiniu.com"; //上传App的url
    ...
    void DrawBuild()
    {
                ...
                if (mEditorAssetBundleVersion.GenerationIterativeVersion() != null)
                {
                    if(mAutoUploadServer)
                    {
                        if(mAutoUploadServerAll)
                            mEditorAssetBundleVersion.UploadFileToServerAll(mEditorGameBuildConfigurations.mConfig.net.ipAdressTypeName[hosInt1],host1,mEditorGameBuildConfigurations.mConfig.net.ipAdressTypeName[hosInt2],host2);
                        else
                            mEditorAssetBundleVersion.UploadFileToServer();
                    }
        ...
        mInputNeedGetRealName = EditorGUILayout.TextField(mInputNeedGetRealName, GUILayout.Height(40), GUILayout.Width(100));
    ...
    void BeginBuild()
    {
        ...
        string buildResult = BuildPipeline.BuildPlayer(scenes.ToArray(), apkFullPath, EditorUserBuildSettings.activeBuildTarget, options);
