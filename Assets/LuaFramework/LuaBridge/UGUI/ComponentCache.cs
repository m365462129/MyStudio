...
public class ComponentCache : MonoBehaviour
{
    ...
    // [System.Serializable]
    // public class Object_Injection:Injection<Object>{
    //     public string typeName;
    // }
    // public List<Object_Injection> objectList;
    ...
    [System.Serializable]
    public class QuickGrid_Injection : Injection<littlerbird.UI.QuickGrid> { }
    public List<QuickGrid_Injection> quickGridList;
    ...
    [System.Serializable]
    public class SimpleScrollView_Injection : Injection<SimpleScrollView> { }
    public List<SimpleScrollView_Injection> simpleScrollViewList;
    ...
    public void SetCacheToLua(LuaTable table) {
        ...
        if (quickGridList != null) {
            foreach (var item in quickGridList) {
                tableTmp[item.name] = item.value;
            }
        } 
        ...
        if (simpleScrollViewList != null) {
            foreach (var item in simpleScrollViewList) {
                tableTmp[item.name] = item.value;
            }
        } 
