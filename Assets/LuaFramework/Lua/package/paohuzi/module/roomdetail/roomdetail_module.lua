...
local RoomDetailModule = class("PaoHuZi.RoomDetailModule", ModuleBase)
...
function RoomDetailModule:on_click(obj, arg)	
	...
	if obj == self.roomDetailView.buttonClose.gameObject then
		ModuleCache.ModuleManager.hide_module("paohuzi", "roomdetail")
		return	
	elseif obj == self.roomDetailView.buttonCheckRoundVideo.gameObject then
		ModuleCache.ModuleManager.show_module("paohuzi", "playvideo")
