...
---@class TableCPBaseModel
local TableCPBaseModel = class('tablelBaseModel', Model)
local NetClientManager = ModuleCache.net.NetClientManager
local Time = Time


function TableCPBaseModel:initialize(...)
...
function TableCPBaseModel:request_heartbeat()
...
function TableCPBaseModel:request_exit_room()
    local msgId, request = self.netMsgApi:create_request_data("Msg_Exit_Room")
    Model.send_msg(self, msgId, request, "gameServer", self.SeqNo)
end

function TableCPBaseModel:request_chu_mj(pai, ting, coverdTable)
...
function TableCPBaseModel:request_kai_ju_ting_mj()
    local msgId, request = self.netMsgApi:create_request_data("Msg_Table_TING")
    Model.send_msg(self, msgId, request, "gameServer", self.SeqNo)
end

function TableCPBaseModel:request_chi_mj(pai, chifa)
...
function TableCPBaseModel:request_dissolve_room(action)
...
-- 踢出用户
function TableCPBaseModel:request_kick_player(playerId)
...
-- 上报状态 0 =正常 1=离开 
function TableCPBaseModel:request_report_player(state)
