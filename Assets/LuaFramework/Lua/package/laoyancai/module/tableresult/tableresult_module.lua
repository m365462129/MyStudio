...
local TableResultModule = class("LaoYanCai.TableResultModule", ModuleBase)
...
function TableResultModule:on_show(data, gameName)
	...
	gameName = data.gameName or 'laoyancai'
	local path = "package.laoyancai.module.tableresult.game.tableresult_"
