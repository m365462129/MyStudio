...
function table3d_helper:set_LaiZi(mj3d,isGray)
    local spriteName = self.module.view.ConfigData.laiziTag or 4
    local texture = self.module.view.tagSpriteH:FindSpriteByName(tostring(spriteName)).texture
    mj3d:setTag(texture)
end

---切换麻将皮肤风格
function table3d_helper:switchMj3dSkinStyle(type)
