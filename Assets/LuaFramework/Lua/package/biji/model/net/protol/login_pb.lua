...
module('package.biji.model.net.protol.login_pb')
...
CMD_CREATEROOM.fields = {CMD_CREATEROOM_GAMENAME_FIELD, CMD_CREATEROOM_ROUNDCOUNT_FIELD, CMD_CREATEROOM_RULE_FIELD, CMD_CREATEROOM_HALLID_FIELD}
...
CMD_ENTERROOM.fields = {CMD_ENTERROOM_ROOMID_FIELD, CMD_ENTERROOM_GAMENAME_FIELD, CMD_ENTERROOM_MATCHID_FIELD}
