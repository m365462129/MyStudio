...
function InnerRoomDetailView:initialize(...)
    -- 初始View
    View.initialize(self, "biji/module/roomdetail/biji_windowinnerroomdetail.prefab", "BiJi_WindowInnerRoomDetail", 1)
...
function InnerRoomDetailView:initRoomInfo(roomInfo)
    ...
    if(roomInfo.gameType == 0) then
        self.textRoomRoundInfo.text = "欢乐比鸡 ";
    elseif(roomInfo.gameType == 1) then
        self.textRoomRoundInfo.text = "舒城比鸡 ";
    end
