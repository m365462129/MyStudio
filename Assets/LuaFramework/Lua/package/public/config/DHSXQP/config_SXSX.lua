...
ConfigChild.createRoomTable =
{
    { --陕西
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"BuKeJiePao\":false",toggleType = 1,toggleTitle = "普通平胡",toggleIsOn = true},
                    {disable = false,json = "\"BuKeJiePao\":true",toggleType = 1,toggleTitle = "只炸不胡",toggleIsOn = false},
                }
            }
        },
        { 
            ...
            {
                {
                    ...
                    {disable = false,json = "\"258YingJiang\":true",toggleType = 2,toggleTitle = "258硬将",toggleIsOn = false},
                    {disable = false,json = "\"Hu258JiaFan\":true",toggleType = 2,toggleTitle = "胡258加番",toggleIsOn = true},
                    {disable = false,json = "\"Jiang258JiaFan\":true",toggleType = 2,toggleTitle = "将258加番",toggleIsOn = true},
                }
            }
        },
        { 
            ...
            {
                {
                    {disable = false,json = "\"QiXiaoDuiJiaFan\":true",toggleType = 1,toggleTitle = "可胡七对(加番)",toggleIsOn = true},
                    {disable = false,json = "\"QiXiaoDuiJiaFan\":false",toggleType = 1,toggleTitle = "可胡七对(不加番)",toggleIsOn = false},
                },
                {
                    {disable = false,json = "\"QingYiSeJiaFan\":true",toggleType = 2,toggleTitle = "清一色加番",toggleIsOn = true},
                },
            }
        },
        { 
