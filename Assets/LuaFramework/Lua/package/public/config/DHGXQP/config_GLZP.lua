...
ConfigChild.createRoomTable =
{
    { --大冶字牌
        ...
        {
            tag = {togglesTile = "起胡:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "胡子:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        
        {
            ...
            {
                {
                    {disable = false,json = "\"DiaoPaoRule\":true",toggleType = 1,toggleTitle = "可点炮",toggleIsOn = true},
                    {disable = false,json = "\"DiaoPaoRule\":false",toggleType = 1,toggleTitle = "不可点炮",toggleIsOn = false},
                }
            }
        },
        {
            tag = {togglesTile = "翻醒:",rowNum = 3},--toggle标题信息
            list =
            {
                {
