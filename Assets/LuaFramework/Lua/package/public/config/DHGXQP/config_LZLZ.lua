...
ConfigChild.createRoomTable =
{
    { --柳州麻将
        ...
        {
            tag = {togglesTile = "钓法:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"MaiMa\":true",toggleType = 1,toggleTitle = "一五九钓鱼",toggleIsOn = true},
                    {disable = false,json = "\"MaiMa\":false",toggleType = 1,toggleTitle = "跟庄钓鱼",toggleIsOn = false},
                }
            }
        },
        {
            tag = { togglesTile = "钓鱼:", rowNum = 3}, --toggle标题信息
            list =
            {
                {
