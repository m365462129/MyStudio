...
ConfigChild.createRoomTable =
{
    { --极速
        ...
        { 
            tag = {togglesTile = "人数:",rowNum = 3,bigShow = "2_1"},--toggle标题信息
            list =
            {
                {
        ...
        { 
            tag = {togglesTile = "人数:",rowNum = 3,bigShow = "2_2"},--toggle标题信息
            list =
            {
                {
        ...
        { 
            tag = {togglesTile = "人数:",rowNum = 3,bigShow = "2_3"},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"playerCount\":6",toggleType = 1,toggleTitle = "2-6人(2副牌)",toggleIsOn = false,clickTip = "使用2副牌来游戏"},
        ...
        { 
            tag = {togglesTile = "规则:",rowNum = 3},--toggle标题信息
            list =
            {
                {
