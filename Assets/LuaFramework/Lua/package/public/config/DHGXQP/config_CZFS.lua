...
ConfigChild.createRoomTable =
{
    { --扶绥麻将
        ...
        {
            tag = {togglesTile = "鬼牌:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "买马:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"ZhaMa\":0",toggleType = 1,toggleTitle = "不买",toggleIsOn = true, clickSmallShow = "3_1"},
                    { disable = false, json = "ZhaMa", toggleType = 1, toggleTitle = "买", toggleIsOn = false, dropDown = "2,4,6,8,10", dropDefault = 0, dropAddStr = "马"},
                    {disable = false,json = "\"LiuDun\":true",toggleType = 2,toggleTitle = "留足马牌",toggleIsOn = true,smallShow = "3_1",smallShowType = 2,clickTip = "买几匹马则留几张牌进入流局"},
                }
            }
        },
        {
            ...
            {
                {
                    ...
                    { disable = false, json = "\"DianPaoBuSuanMenQ\":false", toggleType = 2, toggleTitle = "点炮算门清", toggleIsOn = true},
                    { disable = false, json = "\"SiShuang\":true", toggleType = 2, toggleTitle = "死双", toggleIsOn = false,clickTip = "玩家在碰三比关系中，胡牌分数翻2倍"},
                },
                {
                    { disable = false, json = "\"ShiSanYao\":true", toggleType = 2, toggleTitle = "十三幺", toggleIsOn = false, clickSmallShow = "5_1",clickTip = "可选择24分和48分两个算分方式之一"},
                    { disable = false, json = "\"ShiSanYao24\":true", toggleType = 1, toggleTitle = "十三幺24分", toggleIsOn = true, smallShow = "5_1", smallShowType = 1,clickTip = "点炮24分，自摸16分/家"},
                    { disable = false, json = "\"ShiSanYao24\":false", toggleType = 1, toggleTitle = "十三幺48分", toggleIsOn = false, smallShow = "5_1", smallShowType = 1,clickTip = "点炮48分，自摸32分/家"},
                },
            }
        },
        {
