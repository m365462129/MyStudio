...
ConfigChild.createRoomTable =
{
    { --安徽跑得快
        ...
        {
            tag = {togglesTile = "基础分:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        configJson = '{\"game_type\":0,\"playerCount\":5,\"HallID\":0,\"GameType\":0,\"last_five_as_triple_p2\":false,\"enableSequentialSingle\":true,\"enableBondCardScore\":false,',
...
<size=28>
1）五同色炸：5张及以上的炸弹中有五张牌同色的牌型，奖励1倍基础分
2）六同色炸：6张及以上的炸弹中有六张牌同色的牌型，奖励2倍基础分
3）七张炸弹：三小王、三大王，奖励1倍基础分
4）八张炸弹：奖励2倍基础分，四张王时，两大两小只有1倍喜钱，三大一小或三小一大2倍喜钱
5）九张炸弹：奖励3倍基础分
6）十张炸弹：五个王，奖励4倍基础分
7）十一张炸弹：奖励5倍基础分
8）十二张炸弹：六个王，奖励6倍基础分
...
<size=28>
1）三打二结算：
地主积分=基础分*3*（明牌倍数）+自己喜钱分*4-其他玩家喜钱分 
狗腿积分=基础分*3*（明牌倍数）+自己喜钱分*4-其他玩家喜钱分
农民积分=基础分*2*（明牌倍数）+自己喜钱分*4-其他玩家喜钱分
明牌倍数，2的n次方,N为明牌的人数,1人有喜牌，其他四人都要给喜钱
如：基础分为2，三个人明牌，地主一个人有一个七张炸弹喜牌，且地主方胜利，则各位的得分为：地主进钱=2X3X8+1X3；狗腿进钱=2X3X8-1;农民出钱=2X2X8+1
2）地主1v4结算：
地主积分=基础分*8*2*（明牌倍数）+自己喜钱分*4-其他玩家喜钱分
农民积分=基础分*2*2*（明牌倍数）+自己喜钱分*4-其他玩家喜钱分
如：基础分为2，三个人明牌，地主一个人有一个七张炸弹喜牌，且地主方胜利，则各位的得分为：地主进钱=2X8X2X8+1X4;农民出钱=2X2X2X8-1
</size>
