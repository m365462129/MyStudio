...
ConfigChild.createRoomTable =
{
    { --如东长牌
        ...
        {
            tag = {togglesTile = "买庄:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"MaiZhuang\":0",toggleType = 1,toggleTitle = "无倍数",toggleIsOn = false},
                    {disable = false,json = "\"MaiZhuang\":1",toggleType = 1,toggleTitle = "1/1.5/2",toggleIsOn = false},
                    {disable = false,json = "\"MaiZhuang\":2",toggleType = 1,toggleTitle = "1/2/3",toggleIsOn = true},
                    {disable = false,json = "\"MaiZhuang\":3",toggleType = 1,toggleTitle = "2/3/4",toggleIsOn = false},
                    {disable = false,json = "\"MaiZhuang\":4",toggleType = 1,toggleTitle = "3/4/5",toggleIsOn = false},
                    {disable = false,json = "\"MaiZhuang\":5",toggleType = 1,toggleTitle = "3/5/7",toggleIsOn = false},
                    {disable = false,json = "\"MaiZhuang\":6",toggleType = 1,toggleTitle = "5/7/10",toggleIsOn = false},
                }
            }
        },
        {
            tag = {togglesTile = "将牌:",rowNum = 3},--toggle标题信息
            list =
            {
                {
            ...
            {
                {
                    ...
                    {disable = false,json = "\"MenPiao\":true",toggleType = 2,toggleTitle = "闷飘",toggleIsOn = false},
                    {disable = false,json = "\"HaiDiLaoYue\":true",toggleType = 2,toggleTitle = "海底捞月",toggleIsOn = false},
                }
            }
        },
        --{
