    ...
    { --江苏关牌
        ...
        },
        {
            ...
            list =
            {
                ...
                --{
                --    {disable = true,json = "\"init_card_cnt\":16",toggleType = 1,toggleTitle = "16张牌",toggleIsOn = true,smallShow="2_1",smallShowType = 2},
                ...
                --},
                {
                    ...
                    {disable = true,json = "\"tripleA_is_bomb\":true",toggleType = 2,toggleTitle = "3A带1张为炸弹",toggleIsOn = true},
                },
            }
        },
        {
        ...
        configJson = "{\"game_type\":1,\"HallID\":0,\"GameType\":1,\"init_card_cnt\":16,\"wanfa\":\"jiangsu_guanpai\","
    },
    ...
    { --江苏跑得快
        ...
        },
        {
            ...
            list =
            {
                ...
                {
                    {disable = false,json = "\"first_must_black3\":true",toggleType = 1,toggleTitle = "首出必出黑桃三",toggleIsOn = false,clickTip = "赢家先出时，第1局必出"},
                    {disable = false,json = "\"first_must_black3\":false",toggleType = 1,toggleTitle = "可不出黑桃3",toggleIsOn = true},
                },
            }
        },
        ...
        configJson = "{\"game_type\":2,\"HallID\":0,\"GameType\":2,\"wanfa\":\"jiangsu\","
    },
}
...
4）三带二：三张相同点数的牌带一对，带的牌只能是对子，不能带两个单牌；如：33344
5）飞机带翅膀：两个或两个以上相连的三通张牌带上两对或两对以上的牌型，带的牌必须是对子，不能带单张；如：3334445566
...
<size=28><color=#7c5608>
1）当玩家胜利时，根据输家手中剩余牌数计分，剩14-10张2分一张；剩9-1张1分一张.
2）如果玩家在该局游戏中一张牌都没有出，直接输50；只出了一张牌，直接输40.
3）胜利者赢得所有输家的分数.
</color></size>
]],
