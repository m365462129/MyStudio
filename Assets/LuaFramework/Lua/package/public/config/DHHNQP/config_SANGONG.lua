...
ConfigChild.createRoomTable =
{
    ...
    {--自由抢庄
        ...
        {
            tag = {togglesTile = "倍数:",rowNum = 3, bigShow = "4_1",bigShowType = 2 },--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "牌型:",rowNum = 3,bigShow = "4_1",bigShowType = 2 },--toggle标题信息
            list =
            {
                {
