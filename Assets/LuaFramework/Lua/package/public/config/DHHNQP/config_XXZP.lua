...
ConfigChild.createRoomTable =
{
    { --大冶字牌
        ...
        {
            tag = {togglesTile = "点炮:",rowNum = 3},--toggle标题信息
            list =
            {
                {
            ...
            {
                {
                    ...
                    {disable = false,json = "\"DiFen\":200",toggleType = 1,toggleTitle = "0.2",toggleIsOn = false},
                    ...
                    {disable = false,json = "\"DiFen\":1000",toggleType = 1,toggleTitle = "1",toggleIsOn = true},
                }
            }
        },
        {
