...
ConfigChild.createRoomTable =
{
    { --大冶字牌
        ...
        
        {
            ...
            list =
            {

                {
                    ...
                    {disable = false,json = "\"FengDing\":400",toggleType = 1,toggleTitle = "400胡息",toggleIsOn = false},
                }
            }
        },
        {
        ...
        {
            tag = {togglesTile = "接炮:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"JiePaoFengDing\":0",toggleType = 1,toggleTitle = "不封顶",toggleIsOn = true},
                    {disable = false,json = "\"JiePaoFengDing\":100",toggleType = 1,toggleTitle = "100封顶",toggleIsOn = false},
                }
            }
        },
      
        {
            tag = {togglesTile = "底分:",rowNum = 5},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"DiFen\":100",toggleType = 1,toggleTitle = "0.1",toggleIsOn = false},
                    {disable = false,json = "\"DiFen\":200",toggleType = 1,toggleTitle = "0.2",toggleIsOn = true},
                    {disable = false,json = "\"DiFen\":300",toggleType = 1,toggleTitle = "0.3",toggleIsOn = false},
                    {disable = false,json = "\"DiFen\":500",toggleType = 1,toggleTitle = "0.5",toggleIsOn = false},
                    {disable = false,json = "\"DiFen\":1000",toggleType = 1,toggleTitle = "1",toggleIsOn = false},
                }
            }
        },
        {
            tag = {togglesTile = "换位:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        caculPrice = function(roundCount, playerNum, payType, bankerType)
            return Config.caculate_priceXX(roundCount, playerNum, payType, bankerType)
        end,
        addJson = "\"PlayerNum\":3,\"roundCount1\":1,"
    },
}
