...
ConfigChild.createRoomTable =
{
    { --红中
        ...
        { 
            tag = {togglesTile = "胡牌:",rowNum = 3},--toggle标题信息
            list =
            {
                {
            ...
            {
                {
                    ...
                    {disable = false,json = "\"QiangGangQuanBao\":true",toggleType = 2,toggleTitle = "抢杠包三家",toggleIsOn = true},
                    {disable = false,json = "\"QiangGangWuHongZhong\":true",toggleType = 2,toggleTitle = "抢杠无红中",toggleIsOn = false},
                }
            }
        },
        { 
            tag = {togglesTile = "扎码:",rowNum = 4},--toggle标题信息
            list =
            {
                {
                    ...
                    {disable = false,json = "\"ZhaMa\":5",toggleType = 1,toggleTitle = "扎6码",toggleIsOn = false,clickTip="胡牌后摸6张牌，如果数字为159或者红中，则算中码，每中一码多1分。", clickSmallShow = "5_3"},
                    {disable = false,json = "\"ZhaMa\":2",toggleType = 1,toggleTitle = "一码全中",toggleIsOn = false,clickTip="胡牌后摸1张牌，数值为几则加积分，如果摸到红中则加10分。"},
                },
                {
                    {disable = false,json = "\"BuZhongSuanQuanZhong\":true",toggleType = 2,toggleTitle = "不中算全中",toggleIsOn = true,clickTip="一个码都没扎中时，算6个码全都扎中了", smallShow = "5_3", smallShowType = 1},
                    {disable = false,json = "\"QuanZhongFanBei\":true",toggleType = 2,toggleTitle = "全中翻倍",toggleIsOn = true,clickTip="扎码全中，扎码分数翻倍", smallShow = "5_3", smallShowType = 1},
                    rowNum = 3,
                }
            }
        },
        ...
        caculPrice = function (roundCount, playerCount, payType, bankerType)
            return Config.caculate_price_HNQP_HZMJ(roundCount, playerCount, payType, bankerType)
        end,
        addJson = "\"QiangGangWuHongZhong\":false,",
    },
}
