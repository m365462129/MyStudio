...
ConfigChild.createRoomTable =
{
    { --轮流坐庄
        ...
        { 
            tag = {togglesTile = "下注:",rowNum = 4,maxValidNum = 5, minValidNum = 2},--toggle标题信息
            list =
            {
                {
    ...
    { --看牌抢庄
        ...
        {
            tag = {togglesTile = "抢庄:",rowNum = 4,maxValidNum = 4,minValidNum = 1},--toggle标题信息
            list =
            {
                {
    ...
    { --通比牛牛
        ...
        { 
            tag = {togglesTile = "底注:",rowNum = 4},--toggle标题信息
            list =
            {
                {
