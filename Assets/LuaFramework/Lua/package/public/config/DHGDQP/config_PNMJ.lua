...
ConfigChild.createRoomTable = {
    { --普宁逼胡
        ...
        {
            tag = { togglesTile = "奖马:", rowNum = 3 }, --toggle标题信息
            list = {
                {
    ...
    { --普宁客家
        ...
        {
            tag = { togglesTile = "马牌:", rowNum = 3 }, --toggle标题信息
            list = {
                {
        ...
        {
            tag = { togglesTile = "封顶:", rowNum = 3,bigShow = "4_2",bigShowType = 1 }, --toggle标题信息
            list = {
                {
        ...
        {
            tag = { togglesTile = "封顶:", rowNum = 3,bigShow = "4_3",bigShowType = 1 }, --toggle标题信息
            list = {
                {
