...
ConfigChild.createRoomTable =
{
    { --换换麻将
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"KeJiePao\":true",toggleType = 2,toggleTitle = "可接炮",toggleIsOn = false},
                    {disable = false,json = "\"QiangGangHu\":true",toggleType = 2,toggleTitle = "抢杠胡",toggleIsOn = false},
                }
            }
        },
        {
...
⑤过胡惩罚:一圈内对方打出的牌能胡却没有胡，则在未经过自己时再次出
  现可接炮胡的牌时也都不可以胡牌;
⑥不可胡牌型:七对，十三烂牌型不可胡牌;
</size>
