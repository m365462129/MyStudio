...
ConfigChild.createRoomTable =
{
    { --极速
        ...
        { 
            tag = {togglesTile = "算分:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        { 
            tag = {togglesTile = "设置:",rowNum = 3},--toggle标题信息
            list =
            {
                {
...
1）2人模式，A>B，B输给A基础分*1；
2）3人模式，A>B>C，C输给A基础分*2，B输给A基础分*1；
3）4人模式，A>B>C>D，D输给A基础分*3，C输给A基础分*2，B输给A基础分*1；
4）5人模式，A>B>C>D>E，E输给A基础分*4，D输给A基础分*3，C输给A基础分*2，B输给A基础分*1；
5）6人模式，A>B>C>D>E>F，F输给A基础分*5，E输给A基础分*4，D输给A基础分*3，C输给A基础分*2，B输给A基础分*1；
。
