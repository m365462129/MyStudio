...
ConfigChild.createRoomTable =
{
    { --轮流坐庄
        ...
        { 
            tag = {togglesTile = "倍率:",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        { 
            tag = {togglesTile = "翻倍:",rowNum = 3},--toggle标题信息
            list =
            {
                {
    ...
    { --炸金牛
        ...
        { 
            tag = {togglesTile = "上限:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"maxBetScore\":3",toggleType = 1,toggleTitle = "6",toggleIsOn = true},
                    {disable = false,json = "\"maxBetScore\":5",toggleType = 1,toggleTitle = "10",toggleIsOn = false},
                },
            }
        },
        {
...
ConfigChild.HowToPlayGoldTexts = ConfigChild.HowToPlayTexts
