...
2）地主1v4结算：
地主积分=基础分*8*明牌倍数+自己喜钱分*4-其他玩家喜钱分，任何人明牌都算倍数
农民积分=基础分*2*明牌倍数+自己喜钱分*4-其他玩家喜钱分，任何人明牌都算倍数
如：基础分为2，三个人明牌，地主一个人有一个七张炸弹喜牌，且地主方胜利，则各位的得分为：地主进钱=2X8X8+1X4;农民出钱=2X2X8-1
</size>
