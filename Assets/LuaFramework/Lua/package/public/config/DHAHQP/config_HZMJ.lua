...
ConfigChild.createRoomTable =
{
    { --红中
        ...
        {
            tag = {togglesTile = "测试:",rowNum = 3, test = true},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"Is3D\":1",toggleType = 1,toggleTitle = "3D",toggleIsOn = false},
                    {disable = false,json = "\"Is3D\":2",toggleType = 1,toggleTitle = "2D",toggleIsOn = true},
                }
            }
        },
        {
