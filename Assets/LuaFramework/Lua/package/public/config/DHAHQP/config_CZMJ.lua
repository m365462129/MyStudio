...
ConfigChild.createRoomTable =
{
    { --青阳平胡
        ...
        {
            tag = {togglesTile = "倍数:",rowNum = 4},--toggle标题信息
            list =
            {
                {
            ...
            {
                {
                    ...
                    {disable = false,json = "\"SiXi\":true",toggleType = 2,toggleTitle = "四喜",toggleIsOn = false,clickTip="勾选后胡牌时如果有4个天用牌时额外加5分，不勾选则没有此加分规则。"},
                    {disable = false,json = "\"QueYiMen\":true",toggleType = 2,toggleTitle = "缺一门",toggleIsOn = false,clickTip="勾选后胡牌时满足缺一门条件时加对应的分数，不勾选则不加分。"},
                    {disable = false,json = "\"WuQueBuKai\":true",toggleType = 2,toggleTitle = "无缺不开",toggleIsOn = false,clickTip="勾选后必须缺一门才能胡牌，不勾选则无限制。"},
                    {disable = false,json = "\"DuoTianYongXiaoDao\":true",toggleType = 2,toggleTitle = "多天用可小倒",toggleIsOn = true,clickTip="勾选后如果有两个以及两个以上天用牌时也可胡小倒牌型，不够选则不能胡小倒牌型。"},
                }
            }
        },
        {
    ...
    { --青阳辣子
            ...
            {
                {
                    ...
                    {disable = false,json = "\"YouPao\":true",toggleType = 2,toggleTitle = "压跑",toggleIsOn = false,clickTip="勾选后本局带压跑玩法，不勾选则没有压跑玩法。"},
        ...
        { 
            tag = {togglesTile = "底分:",rowNum = 3},--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"PaiXingFen\":124",toggleType = 1,toggleTitle = "124",toggleIsOn = true,ruleTitle = "底分124",clickTip="本局游戏小胡10分、大吊车20分、辣子胡40分"},
                    {disable = false,json = "\"PaiXingFen\":346",toggleType = 1,toggleTitle = "346",toggleIsOn = false,ruleTitle = "底分346",clickTip="本局游戏小胡30分、大吊车40分、辣子湖60分"},
                }
            }
        },
        {
