...
ConfigChild.createRoomTable =
{
    { --无为
        ...
        { 
            tag = {togglesTile = "起番:",rowNum = 3},--toggle标题信息
            list =
            {
                {
            ...
            {
                {
                    ...
                    {disable = false,json = "\"KaXingZi\":true",toggleType = 2,toggleTitle = "卡星子",toggleIsOn = false,clickTip="勾选后卡胡星子本身有额外加分。"},
                    {disable = false,json = "\"LunZhuang\":true",toggleType = 2,toggleTitle = "轮庄",toggleIsOn = false,clickTip="勾选后庄家胡牌继续坐庄，其他情况轮庄。不勾选则谁胡谁庄。"},
                }
            }
        },
        { 
            tag = {togglesTile = "庄分:",rowNum = 3},--toggle标题信息
            list =
            {
                {
