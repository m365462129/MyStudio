...
{
    {
        ...
        { 
            ...
            list =
            {
                ...
                {
                    {disable = false,json = "\"freeSeeCard\":true",toggleType = 2,toggleTitle = "自由看牌",toggleIsOn = true},
                    {disable = false,json = "\"freeGiveup\":true",toggleType = 2,toggleTitle = "自由弃牌",toggleIsOn = true},
                },
            }
        },
...
1）坐庄：首局房主当庄，以后谁赢谁坐庄；
2）锅底：在发牌前每个玩家投一定的底注，上限6分和10分是1分的底，上限20分是2分的底；
