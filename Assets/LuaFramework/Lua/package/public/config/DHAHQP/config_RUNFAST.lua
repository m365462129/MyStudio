    ...
    { --安徽跑得快
        ...
        { 
            ...
            list =
            {
                ...
                {
                    {disable = false,json = "\"allow_pass\":false",toggleType = 1,toggleTitle = "有牌必压",toggleIsOn = false,clickSmallShow="2_4"},
                    {disable = false,json = "\"allow_pass\":true",toggleType = 1,toggleTitle = "可不要",toggleIsOn = true},
                    {disable = false,json = "\"have2mustpressA\":true",toggleType = 2,toggleTitle = "有2必打A",toggleIsOn = false,smallShow="2_4",smallShowType = 2},
                },
                {
                ...
                {
                    {disable = true,json = "\"tripleA_is_bomb\":true",toggleType = 2,toggleTitle = "3A带1张为炸弹",toggleIsOn = true,smallShow="2_1",smallShowType = 2},
        ...
        configJson = "{\"game_type\":1,\"HallID\":0,\"GameType\":1,"
    },
    { --经典玩法
        {--不同分类 局数 人数..
            tag = {togglesTile = "局数:",rowNum = 3},--toggle标题信息
        ...
        configJson = "{\"game_type\":2,\"HallID\":0,\"GameType\":2,"
    },
}
...
5）出牌规则：
 ...
 牌是否必须包含黑桃3.
 ◆ 在黑桃3必出的模式下抓到4张3，如先出一张黑桃3，剩下的3个
 3为炸弹.
 ◆ 2人模式下若没有黑桃3则红桃3先出，没有继续判定直到A.
