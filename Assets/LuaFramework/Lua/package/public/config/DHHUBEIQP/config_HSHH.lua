...
ConfigChild.createRoomTable =
{
    { --黄石晃晃麻将
        ...
        --{
        --    tag = { togglesTile = "结算:", rowNum = 3 }, --toggle标题信息
        --    list = {
        --        {
        ...
        {
            tag = {togglesTile = "底分:",rowNum = 4},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "",rowNum = 3},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "起胡:",rowNum = 4, bigShow = "1_1", showType = {2,3}},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "起胡:",rowNum = 4, bigShow = "1_2", showType = {2,3}},--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "封顶:",rowNum = 3, bigShow = "1_1",bigShowType = 1 },--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"FengDingType\":1",toggleType = 1,toggleTitle = "银顶40,金顶50",toggleIsOn = true},
                    {disable = false,json = "\"FengDingType\":3",toggleType = 1,toggleTitle = "银顶50,金顶80",toggleIsOn = false,showType = {2,3}},
                    {disable = false,json = "\"FengDingType\":2",toggleType = 1,toggleTitle = "银顶80,金顶100",toggleIsOn = false},
                    {disable = false,json = "\"FengDingType\":4",toggleType = 1,toggleTitle = "银顶160,金顶200",toggleIsOn = false, showType = {2,3}},
                }
            }
        },
        {
            tag = {togglesTile = "封顶:",rowNum = 3, bigShow = "1_2",bigShowType = 1 },--toggle标题信息
            list =
            {
                {
                    {disable = false,json = "\"FengDingType\":1",toggleType = 1,toggleTitle = "银顶40,金顶50",toggleIsOn = false},
                    {disable = false,json = "\"FengDingType\":3",toggleType = 1,toggleTitle = "银顶50,金顶80",toggleIsOn = false,showType = {2,3}},
                    {disable = false,json = "\"FengDingType\":2",toggleType = 1,toggleTitle = "银顶80,金顶100",toggleIsOn = true},
                    {disable = false,json = "\"FengDingType\":4",toggleType = 1,toggleTitle = "银顶160,金顶200",toggleIsOn = false, showType = {2,3}},
                }
            }
        },
        {
            tag = {togglesTile = "特殊:",rowNum = 3, showType = {2,3} },--toggle标题信息
            list =
            {
                {
        ...
        {
            tag = {togglesTile = "",rowNum = 4, isPay = true},--toggle标题信息
            list =--不同group
            {
                {--不同toggle组
