...
ConfigChild.createRoomTable =
{
    { --开口番
        ...
        {
            tag = {togglesTile = "封顶:",rowNum = 3.05},---别不信，就是这样，可以用小数来标识，本质上这个rowNum 只是用来算 间距 和 换行 的被除数
            list =
            {
                {
                    {disable = false,json = "\"FengDing\":1",toggleType = 1,toggleTitle = "银顶40,金顶50",toggleIsOn = true},
                    {disable = false,json = "\"FengDing\":2",toggleType = 1,toggleTitle = "银顶80,金顶100",toggleIsOn = false},
                    {disable = false,json = "\"FengDing\":4",toggleType = 1,toggleTitle = "银顶160,金顶200",toggleIsOn = false},
                }
            }
        },
        {
