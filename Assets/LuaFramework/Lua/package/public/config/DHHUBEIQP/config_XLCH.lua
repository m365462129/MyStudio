...
ConfigChild.createRoomTable =
{
    { --血流成河
        ...
        },
        {
            ...
            {
                {
                    {disable = false,json = "\"DianGangHua\":true",toggleType = 1,toggleTitle = "算点炮",toggleIsOn = true,clickTip = "点杠杠上花胡牌只有点杠玩家出分", ruleTitle = "点杠算点炮"},
                    {disable = false,json = "\"DianGangHua\":false",toggleType = 1,toggleTitle = "算自摸",toggleIsOn = false,clickTip = "点杠杠上花胡牌算自摸三家都要出分", ruleTitle = "点杠算自摸"},
                }
            }
        },
        {
