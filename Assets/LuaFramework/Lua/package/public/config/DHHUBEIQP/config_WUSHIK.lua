...
ConfigChild.createRoomTable =
{
    { --大冶五十K
            ...
            list = {
                {
                    ...
                    { disable = false, json = "\"VoiceChatForbidden\":true", toggleType = 2, toggleTitle = "禁止语音和聊天", toggleIsOn = false },
                }
            }
        },
        {
        ...
        configJson = '{"game_type":1, "GameType":1,\"playerCount\":4,\"HallID\":0, "isKingMagic":true,',
