...
function GoldAddModule:initialize(...)
    ...
    local onAppFocusCallback = function(state)
...
function GoldAddModule:get_shop_products(postId)
    local requestData = {
...
function GoldAddModule:getUserNewMessage()
    local requestData = {
