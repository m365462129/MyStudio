...
function TextPromptModule:create_center_tips_entity(tipType, tipItem)
    ...
    if not entity then
        ...
        entity.textCenterInfo = ModuleCache.ComponentManager.GetComponentWithPath(entity.rootGameObject, "Image/Text", ComponentTypeName.Text)
    end
...
function TextPromptModule:show_center_tips(text, color, remainTime, type)
    print_debug("show_center_tips：", text)
