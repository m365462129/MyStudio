--- 3D麻将 玩家座位类
--- Created by 袁海洲
--- DateTime: 2018/1/3 17:05
---

local SeatHolder2D = require("package.majiangshanxi.module.tablenew.seat.seatholder2d")
...
local MJ3DHodler = require("package.majiangshanxi3d.module.table3d.MJ3DHodler")
...
---添加手张
function SeatHolder3D:add_Hand_Mj(playerState,shouZhangData,index,showHu,lastMjMove,dataIndex)
    local mj3d = self.mj3dHodler:addHandMj(playerState,shouZhangData,index,showHu,lastMjMove,dataIndex)
    if lastMjMove then
...
function SeatHolder3D:update_down_mj(playerState,localSeat)
    ...
    for i=1,# playerState.XiaZhang do
        ...
        local xiaZhangSeat = self.view:server_to_local_seat(xiaZhangData.Seat)
