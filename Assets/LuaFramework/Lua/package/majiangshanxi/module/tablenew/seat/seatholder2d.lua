...
function SeatHolder2D:init_hand()
    ...
    ---@type Mj2DHeapHand
    self.mjHeapHand = require('package.majiangshanxi.module.tablenew.mj.mj2dheap_hand'):new(self.view, 1)
end
...
function SeatHolder2D:init_down()
    ...
    ---@type Mj2DHeapDown
    self.mjHeapDown = require('package.majiangshanxi.module.tablenew.mj.mj2dheap_down'):new(self.view, 3)
end
...
function SeatHolder2D:init_out()
    ...
    ---@type Mj2DHeapOut
    self.mjHeapOut = require('package.majiangshanxi.module.tablenew.mj.mj2dheap_out'):new(self.view, 2)
end
...
function SeatHolder2D:init_hua()
    ...
    ---@type Mj2DHeapHua
    self.mjHeapHua = require('package.majiangshanxi.module.tablenew.mj.mj2dheap_hua'):new(self.view, 4)
end
...
--- 显示连庄数
function SeatHolder2D:show_remain_banker_num(text)
    text = text or ""
    self.remainBankerText.text = text
end
...
--- 设置玩家名称
function SeatHolder2D:set_player_name(name)
...
function SeatHolder2D:play_action_tx(action)
    ...
    local newChuTX = TableUtil.poor("ChuTX", self.chuTXPos, Vector3.zero, self.view.poorObjs, self.view.clones)
