        ...
        for i = 1, #childs do
            ...
            if(obj.activeSelf) then
                ...
                if(self.view:is_top(params.downData.Seat, params.serverSeat)) then
                    fromYou = (#params.downData.Pai == 3 and curIndex == 2) or (#params.downData.Pai == 4 and curIndex == 4)
                ...
                if(self.view:is_laizi(pai)) then
                    mj:set_lai_zi(gray,self.view.ConfigData.laiziTag or 4, nil, params.notYellow)
                end
