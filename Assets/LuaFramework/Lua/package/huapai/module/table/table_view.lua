...
local ViewBase = require('package.huapai.module.tablebase.tablebase_view')

---@class PaoHuZiTableView:TableBaseView
local TableView = class("HuaPai.TableView", ViewBase)

local Manager = require("package.public.module.function_manager")
local ModuleCache = ModuleCache

function TableView:initialize(...)
    ViewBase.initialize(self, "huapai/module/table/huapai_table.prefab", "HuaPai_Table", 0)
    ...
    self.PaiZhongJian = Manager.FindObject(self.cloneRoot, "PaiZhongJian")
    ...
    self.gridRoot = Manager.FindObject(self.root, "Players/HandView/Grid")
    ...
    self.CenterObj = Manager.FindObject(self.root, "Center/CenterPos")
