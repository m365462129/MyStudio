...
-- 此处必须与路径一致
local path = "package.huapai.model.net.protol."
...
NetMsgApi.msgName2MsgData.Msg_Table_Zhua = {"1004", "ACTION_ZHUA", "", "", "Game_pb", "Game_pb"}
...
NetMsgApi.msgName2MsgData.Msg_Table_Di = {"1008", "ACTION_DI", "", "", "Game_pb", "Game_pb"}
