...
function MuseumRankingView:initialize(...)
    -- 初始View
    View.initialize(self, "henanmj/module/museumranking/henanmj_museumranking.prefab", "HeNanMJ_MuseumRanking", 1)

    self.btnBack= GetComponentWithPath(self.root, "TopLeft/Child/ImageBack", ComponentTypeName.Button)
    
    self.roundTag = GetComponentWithPath(self.root, "Top/TagBtns/Scroll View/Viewport/Content/CopyBtn", ComponentTypeName.Toggle)
    self.scoreTag = GetComponentWithPath(self.root, "Top/TagBtns/Scroll View/Viewport/Content/CopyBtn (1)", ComponentTypeName.Toggle)
    ...
    self.roundPanel = GetComponentWithPath(self.root, "Top/Panels/RoundRanking", ComponentTypeName.Transform).gameObject
    self.scorePanel = GetComponentWithPath(self.root, "Top/Panels/ScoreRanking", ComponentTypeName.Transform).gameObject
    ...
    self.copyItem = GetComponentWithPath(self.root, "Top/ItemPrefabHolder/Item", ComponentTypeName.Transform).gameObject
    self.copyParents = {}
    self.rankTexs = {}
    self.numTexs = {}
    self.loadButtons = {}
