...
function RankView:initialize(...)
    -- 初始View
    View.initialize(self, "henanmj/module/rank/henanmj_rank.prefab", "HeNanMJ_Rank", 1);
    View.set_1080p(self)
...
function RankView:updateRankView()
    ...
    for key, friend in ipairs(self.historyList) do
        ...
        self:startDownLoadHeadIcon(friend.headImg, onComplete);
...
-- 下载头像
function RankView:startDownLoadHeadIcon(url, callback)
