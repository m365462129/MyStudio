...
function InnerRoomDetailView:initialize(...)
    -- 初始View
    View.initialize(self, "shisanzhang/module/roomdetail/shisanzhang_windowinnerroomdetail.prefab", "ShiSanZhang_WindowInnerRoomDetail", 1)
...
function InnerRoomDetailView:initRoomInfo(roomInfo)
    ...
    self.textRoomRoundInfo.text = "十三张 ";
    ...
    self.balance = roomInfo.ruleTable.balance;
...
function InnerRoomDetailView:ShowDetailResult(goItem, showIndex, result)
    ...
    elseif(self.balance ~= 3 and self.balance ~= 5) then
        if self.modelData.curTableData.shisanzhang_gametype == 2 then
            if(result.soloKillScore >= 0) then
                scoreText.text = scoreText.text.."<color=#ab4612>" .. "打枪" .. "</color><color=#e20c0c>+".. result.soloKillScore .."</color> "
            else
        ...
        if self.modelData.curTableData.shisanzhang_gametype == 2 then
            if not result.allKillScore then
                scoreText.text = scoreText.text.."<color=#ab4612>" .. "全垒打" .. "</color><color=#e20c0c> +".. "0"  .."</color> "
            elseif(result.allKillScore >= 0) then
                scoreText.text = scoreText.text.."<color=#ab4612>" .. "全垒打" .. "</color><color=#e20c0c> +".. result.allKillScore  .."</color> "
            else
                scoreText.text = scoreText.text.."<color=#ab4612>" .. "全垒打" .. "</color><color=#7A5844>".. result.allKillScore .."</color> "
            end
