...
function OneGameResultView:initialize(...)
    ...
    --GetComponentWithPath(self.btnRestart, "Image", ComponentTypeName.Transform).gameObject:SetActive(curTableData.RoomType ~= 3 and (not TableManager:cur_game_is_gold_room_type()))
    --GetComponentWithPath(self.btnRestart, "Count down", ComponentTypeName.Transform).gameObject:SetActive(curTableData.RoomType == 3 or TableManager:cur_game_is_gold_room_type())
    ...
    ComponentUtil.SafeSetActive(self.btnReturn, TableManager:cur_game_is_gold_room_type()) ---金币场显示返回按钮
...
function OneGameResultView:refresh_view(newGameState)
    ...
    if TableManager:cur_game_is_gold_room_type() then
        ...
        ComponentUtil.SafeSetActive(self.btnPreTabel, false)  ---金币场不显示显示桌面按钮
    end
