...
function TableModule:on_click(obj, arg)	
	...
	if(obj == self.view.buttonSetting.gameObject) then
		...
		intentData.IsOpenRecommendOutPaiSetting = self.view.ConfigData.IsOpenRecommendOutPaiSetting
		intentData.defRecommendOutPaiSetting = self.view.ConfigData.defRecommendOutPaiSetting
