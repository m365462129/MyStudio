...
---@class TableBaiBaZhangModel : Model
local TableBaiBaZhangModel = class('tableBaiBaZhangModel', Model);

function TableBaiBaZhangModel:initialize( ... )
...
function TableBaiBaZhangModel:request_kick_player(player_id)
...
function TableBaiBaZhangModel:request_ready(isReady,userID)
...
function TableBaiBaZhangModel:request_complete_match(pokers , userID)
...
function TableBaiBaZhangModel:request_ping()
...
function TableBaiBaZhangModel:request_surrender(userID)
    local msgId, request = self.netMsgApi:create_request_data("Msg_Player_Surrender");
    request.userID = tonumber(userID);
    Model.send_msg(self, msgId, request); 
end

function TableBaiBaZhangModel:request_temporary_leave(isLeave, userID)
...
function TableBaiBaZhangModel:request_start()
    local msgId, request = self.netMsgApi:create_request_data("Msg_Table_Start")
    
    Model.send_msg(self, msgId, request) 
end

function TableBaiBaZhangModel:request_submit(pokers , userID, pokerType)
...
--解散房间请求
function TableBaiBaZhangModel:request_dissolve_room(agree)
    local msgId, request = self.netMsgApi:create_request_data("Msg_Table_Dissolve_Room")
    request.agree = agree
    Model.send_msg(self, msgId, request)
end

function TableBaiBaZhangModel:request_exit_room(userID)
...
function TableBaiBaZhangModel:request_chat(msgType, text)
...
------位置信息变化请求
function TableBaiBaZhangModel:request_CustomInfoChange(customInfoJsonString)
