...
function CardCommon.InitConf(no_triple_p1,tripleA_is_bomb, allow_unruled_multitriple,wanfa,pay_all)
    CardCommon.wanfa = wanfa;
    CardCommon.pay_all = pay_all;
    if (wanfa and (wanfa == "jiangsu" or wanfa == "jiangsu_guanpai")) then 
        CardCommon.no_triple_p1=true
        CardCommon.tripleA_is_bomb= wanfa == "jiangsu_guanpai"
        CardCommon.allow_unruled_multitriple = false;
        CardCommon.strong_triple = true;
        CardCommon.strong_double = false;
    else
        ...
        CardCommon.strong_triple = false;
        CardCommon.strong_double = false;
    end
end
