...
--- @class TableDouNiuLogic_RandomBanker:TableDouNiuLogic
...
local TableDouNiuLogic_RandomBanker = class('tableDouNiuLogic_RamdomBanker', TableDouNiuLogic)
local CSmartTimer = ModuleCache.SmartTimer.instance


function TableDouNiuLogic_RandomBanker :initialize(...)
	TableDouNiuLogic.initialize(self, ...)
end

function TableDouNiuLogic_RandomBanker:update()
...
-- 开始广播
function TableDouNiuLogic_RandomBanker:on_table_start_notify(data)
...
--设置庄家通知
function TableDouNiuLogic_RandomBanker:on_table_setbanker_notify(data)
	-- 标识已开始当前局
	local roomInfo = self.modelData.curTableData.roomInfo
...
return TableDouNiuLogic_RandomBanker