...
function CustomImageManager.upload_image_file(bytes, imageSizeV2)
	...
	local v2 = ModuleCache.CustomerUtil.GetTexture2dSize(texture)
	...
	local key = 'image/' .. Util.get_tokenAndTimestamp(UnityEngine.PlayerPrefs.GetString(AppData.PLAYER_PREFS_KEY_USERID, "0"))
