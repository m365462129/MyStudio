...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(ComponentCache.QuickGrid_Injection)),
        _GT(typeof(ComponentCache.SimpleScrollView_Injection)),
    ...
    public static List<Type> dynamicList = new List<Type> {
        ...
        typeof(ComponentCache.QuickGrid_Injection),
        typeof(ComponentCache.SimpleScrollView_Injection),
