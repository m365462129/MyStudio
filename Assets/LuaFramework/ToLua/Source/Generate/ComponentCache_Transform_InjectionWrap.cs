...
public class ComponentCache_Transform_InjectionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(ComponentCache.Transform_Injection), typeof(ComponentCache.Injection<UnityEngine.Transform>));
		L.RegFunction("New", _CreateComponentCache_Transform_Injection);
