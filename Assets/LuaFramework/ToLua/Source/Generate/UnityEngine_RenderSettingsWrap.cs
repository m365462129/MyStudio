...
public class UnityEngine_RenderSettingsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityEngine_RenderSettings);
	...
	static int _CreateUnityEngine_RenderSettings(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UnityEngine.RenderSettings obj = new UnityEngine.RenderSettings();
				ToLua.PushSealed(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UnityEngine.RenderSettings.New");
			}
		}
		catch (Exception e)
		{
